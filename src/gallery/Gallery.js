          ...
          printFotos = array5.map( (b,i)=>(
              <div key={i} className="col-sm-2 col-xs-4">
                  {b.map( (a,i2)=>(<div key={i2}>
                      <span className="glyphicon glyphicon-file" style={{position:"relative", fontSize: "100px"}} > <p style={{position: "absolute", marginTop: "-50px", color: "white", marginLeft: "30px", fontSize: "20px"}}><b>{this.cutName2(a)}</b></p></span>
                        <p>{this.cutName(a)}
